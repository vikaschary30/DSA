...
//                      1) optimal - TC:O(LogN) SC:O(LogN) counts all “good” numbers by computing the total combinations of even and prime digits at respective positions using fast modular exponentiation.
