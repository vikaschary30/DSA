...
//                     2) optimal - TC:O(N) SC:O(1) Use two pointers to eliminate non-celebrities; the remaining candidate is checked against all others to confirm celebrity status.
